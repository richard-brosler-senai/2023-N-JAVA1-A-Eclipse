...
public class TesteConversorTemperaturas {
	...
	public static void main(String[] args) {
		...
		// Por padrão o scanner utiliza as configurações regionais para o separador
		// decimal, no caso do
		...
		// Mostramos a mensagem para o usuário pedindo os dados para converter as
		// temperaturas
		...
		do {
			...
			System.out.println("------------------------------------------------------------------------------");
			// Utilizaremos aqui o print ao invés do println, pois a entrada de dados fica
			// na frente do texto
			...
			if (conv.isFoiCalculado()) {
				System.out.println("A temperatura convertida é " + conv.getResultado());
			} else {
